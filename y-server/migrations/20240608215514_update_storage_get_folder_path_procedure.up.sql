DROP FUNCTION IF EXISTS public.storage_get_folder_path(IN input_endpoint_id integer,IN input_folder_id bigint);

CREATE OR REPLACE FUNCTION public.storage_get_folder_path(IN input_endpoint_id integer,IN input_entry_id bigint)
